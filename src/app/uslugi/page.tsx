...
export default function UslugiPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] flex justify-center items-start font-sans text-[#1b1b1f]">
      ...
      <main className="relative w-full max-w-[414px] bg-[#F5F5F5] min-h-screen sm:min-h-[896px] overflow-hidden flex flex-col">
        <h1 className="text-[26px] font-black tracking-[-0.03em] text-[#1a1f2e] m-5 mt-0">
          Usługi
        </h1>
        <div className="flex-1 overflow-y-auto hide-scrollbar flex flex-col pb-6">
          <div className="px-5 mb-6">
            <div className="flex items-center bg-[#EBEBEC] rounded-[10px] px-3 py-2.5">
              <svg
                className="w-5 h-5 text-[#8e8e93] mr-2"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                strokeWidth="2"
          ...
          <div className="px-5 space-y-7 flex-grow">
            <div>
              <h2 className="text-[15px] font-bold text-[#111827] mb-3 ml-1 tracking-tight">
                Kierowcy i pojazdy
              </h2>
              <div className="bg-white rounded-[24px] shadow-sm border border-gray-100/50 flex flex-col">
                <ServiceListItem
                  icon={<SteeringWheelIcon />}
                  label="Kwalifikacje kierowcy"
            ...
            <div className="pb-8">
              ...
              <div className="bg-white rounded-[24px] shadow-sm border border-gray-100/50 flex flex-col">
                <ServiceListItem
                  icon={<HouseIcon />}
                  label="Umowa najmu mieszkania"
                  iconColor="text-[#22C55E]"
                />
                <ServiceListItem
                  icon={<HouseHeartIcon />}
                  label="Umowa najmu okazjonalnego"
                  iconColor="text-[#22C55E]"
                />
                <ServiceListItem
                  icon={<DocumentIcon />}
                  label="Umowa użyczenia lokalu"
                  iconColor="text-[#22C55E]"
                />
                <ServiceListItem
                  icon={<HouseCheckIcon />}
                  label="Protokół zdawczo-odbiorczy"
                  iconColor="text-[#22C55E]"
                  isLast={true}
                />
              </div>
  ...
  return (
    ...
    >
      <div className="flex items-center w-full">
        <div className={`${iconColor} mr-4 flex-shrink-0`}>{icon}</div>
...
const HouseCheckIcon = () => (
  <svg className="w-[26px] h-[26px]" fill="currentColor" viewBox="0 0 24 24">
    <path d="M12 3L2 12h3v8h14v-8h3L12 3zm-1.17 14.17L7.34 13.68l1.41-1.41 2.08 2.08 4.67-4.67 1.41 1.41-6.08 6.08z" />
  </svg>
);
