...
import { Hourglass, FilePenLine, ChevronLeft } from "lucide-react"; // Оновлено іконку тут
      ...
      <main className="relative w-full max-w-[414px] bg-[#F8F9FA] min-h-screen sm:min-h-[896px] shadow-2xl  overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto hide-scrollbar flex flex-col pb-10">
          ...
          <div className="px-6 mt-8 mb-24">
            <button className="w-full bg-[#cb2027] text-white font-bold text-[18px] rounded-[18px] py-4.5 flex items-center justify-center gap-2 shadow-[0_10px_25px_-5px_rgba(203,32,39,0.4)] active:scale-95 transition-all">
              <FilePenLine size={22} /> {/* Нова іконка тут */}
              Podpis
            </button>
          </div>
